...
| **Prioriteit**         | Must Have |
| **Tijd**               | 2 dagen |
| **Acceptatiecriteria** | - Een gebruiker/gast kan op elk moment de planning openen en de geplande data bekijken<br>- Een gebruiker/gast zonder beheerdersrol kan de planning niet aanpassen<br>- Een gebruiker/gast ziet alleen planningen waarvoor hij/zij is uitgenodigd of die hij/zij zelf heeft aangemaakt |
...
|------------------------|------------------------|
| **Als een**            | gebruiker/gast |
| **Wil ik**             | de data waarop ik beschikbaar ben kunnen opgeven |
...
| **Scenario**           | **Scenario:**<br> Gegeven dat er een evenement wordt georganiseert<br> Wanneer ik mijn beschikbaarheid op geef per datum<br> Dan wordt mijn beschikbaarheid opgeslagen<br> En wordt ik meegenomen in de berekening van de beste datum |
...
| **Prioriteit**         | Must have |
| **Tijd**               | 3 dagen |
| **Acceptatiecriteria** | - Een gebruiker kan bij het aanmaken van een evenement kiezen voor herhaling: dagelijks, wekelijks, maandelijks of jaarlijks<br>- Alle herhalingen zijn zichtbaar in de kalender als aparte items<br>- Een enkele herhaling kan worden gewijzigd zonder dat de rest verandert<br>- een herhalend evenement moet aan een groep gekoppeld worden |
...
| **Tijd**               | 1 dag |
| **Acceptatiecriteria** | - Een evenement-beheerder kan per evenement op een knop klikken om een herinnering te sturen<br>- De herinnering wordt verstuurd via e-mail<br>- De herinnering word alleen gestuurt naar deelnemers die nog niet hun beschikbaarheid hebben opgegeven<br>- Je kan dit als evenement-beheerder eens in de 24 uur doen |
| **Scenario**           | **Scenario:**<br> Gegeven dat de evenement-beheerder over een week de planning klaar wil hebben<br> Wanneer een aantal mensen nog niet hun beschikbaarheid hebben opgegeven<br> Dan kan de evenement-beheerder op een knop drukken<br> En worden die mensen herinnerd dat ze hun beschikbaarheid nog moeten opgeven |
...
| **Prioriteit**         | Should have |
| **Tijd**               | 1 dag |
| **Acceptatiecriteria** | - Een evenement-beheerder kan de automatische reminder uitschakelen<br>- Deelnemers kunnen zich afmelden voor automatische herinneringen<br>- De herinnering bevat de naam van het evenement, datum en tijd |
...
| **Prioriteit**         | Should Have |
| **Tijd**               | 3 dagen |
| **Acceptatiecriteria** | - Als een evenement-beheerder een datum wijzigt, zien alle actieve deelnemers de update binnen 5 seconden<br>- Nieuwe evenementen in een groepskalender verschijnen direct bij alle deelnemers<br>- Er is een zichtbare indicator als de pagina live wordt bijgewerkt |
| **Scenario**           | **Scenario:**<br> Gegeven dat meerdere mensen tegelijk naar de planning kijken<br> Wanneer de evenement-beheerder een datum verzet<br> Dan zien alle anderen de nieuwe datum direct verschijnen op hun scherm<br> En hoeven ze de pagina niet te verversen |
...
| **Zodat**              | ik gebruik kan maken van alle extra functionaliteiten (bijvoorbeeld groepen aanmaken)  |
| **Prioriteit**         | Must Have |
| **Tijd**               | 2 dag |
| **Acceptatiecriteria** | - Een gast kan een account aanmaken met naam, e-mailadres en wachtwoord<br>- Het e-mailadres moet uniek zijn<br>- Het wachtwoord moet minimaal 8 tekens bevatten<br>- Na registratie ontvangt de gast een bevestigingsmail en word ingelogd na het bevestigen van de mail<br>- Een gast kan niet inloggen voordat het e-mailadres is bevestigd via de bevestigingsmail |
| **Scenario**           | **Scenario:**<br> Gegeven dat je de website wil gebruiken maar nog geen account hebt<br> Wanneer je een naam, e-mailadres en wachtwoord invult en op registreren klikt<br> Dan ontvang je een bevestigingsmail<br> En kan je na het bevestigen inloggen met haar nieuwe account |
...
|------------------------|------------------------|
| **Als een**            | gast |
| **Wil ik**             | kunnen inloggen op mijn account |
| **Zodat**              | ik toegang krijg tot mijn planningen en groepen |
| **Prioriteit**         | Must Have |
| **Tijd**               | 1 dag |
| **Acceptatiecriteria** | - Een gast kan inloggen met e-mailadres en wachtwoord<br>- Bij een verkeerd e-mailadres of wachtwoord krijgt de gast een foutmelding<br>- De gebruiker blijft ingelogd totdat hij zichzelf uitlogt of de sessie verloopt |
| **Scenario**           | **Scenario:**<br> Gegeven dat je al een account geregistreerd hebt<br> Wanneer je jou e-mailadres en wachtwoord invult en op inloggen klikt<br> Dan wordt je doorgestuurd naar de hoofdpagina<br> En kan je al je planningen en groepen zien |